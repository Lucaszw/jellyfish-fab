...
class Home {
    constructor(navbar) {
        ...
        document.addEventListener("scroll", _.debounce(this.onScroll.bind(this),20,{leading: true, trailing: true}));
    }
    ...
    onScroll() {
        ...
        let overlapping = isOverlapping(this.navbar.container, this.header.container);
        if (!overlapping) this.navbar.container.style.backgroundColor = "#1f1f2c";
        if (overlapping) this.navbar.container.style.backgroundColor = "#1f1f2cad";
    }
}
